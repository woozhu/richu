...
func TestLightAllDay(t *testing.T) {
  ...
  dayOrNight, _, _ := richu.DayOrNight(68, -118.25, startTime)
  if dayOrNight != richu.Day {
...
func TestDayOrNight(t *testing.T) {
  ...
  for _, cTime := range times {
    dayOrNight, start, end := richu.DayOrNight(32.9, -96.2, cTime)
  ...
  dayOrNight, _, _ := richu.DayOrNight(32.9, -96.2, expectedSunset)
  if dayOrNight != richu.Night {
